...
assert.strictEqual(check.isPublishablePath('lib/engine.js'), true)
...
assert.strictEqual(
  skipNoChange.reason,
  'no plugin, lib or public updates since last publish'
)

const publish = check.shouldPublish({
  now: noon,
  lastPublishTime: '2026-09-10T22:48:14.000Z',
  changedFiles: ['plugin/index.js', 'lib/engine.js', 'README.md']
})
